            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-md-12">
						...
						<?php echo form_open('carrera_materia/add',array("class"=>"form-horizontal")); ?>
							...
							<div class="form-group">
									...
									<div class="col-md-8">
										<select name="carrera_id" class="form-control">
											...
											{
												$selected = ($carrera['id'] == $this->input->post('carrera_id')) ? ' selected="selected"' : "";
							...
							<div class="form-group">
									...
									<div class="col-md-8">
										<select name="materia_id" class="form-control">
											...
											{
												$selected = ($materia['id'] == $this->input->post('materia_id')) ? ' selected="selected"' : "";
